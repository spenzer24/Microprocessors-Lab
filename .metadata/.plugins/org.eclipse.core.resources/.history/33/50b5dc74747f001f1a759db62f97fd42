...
/* Symbols to be used with GPIO driver */
#define BOARD_PININIT_S3_GPIO GPIO                /*!<@brief GPIO peripheral base pointer */
#define BOARD_PININIT_S3_GPIO_PIN_MASK (1U << 9U) /*!<@brief GPIO pin mask */
#define BOARD_PININIT_S3_PORT 1U                  /*!<@brief PORT peripheral base pointer */
#define BOARD_PININIT_S3_PIN 9U                   /*!<@brief PORT pin number */
#define BOARD_PININIT_S3_PIN_MASK (1U << 9U)      /*!<@brief PORT pin mask */
                                                  /* @} */
 ...
 *
 */
void BOARD_PinInit(void); /* Function assigned for the Cortex-M33 (Core #0) */
